...
## Project (Lab, Demonstrations and Experiments)

| Demo/Lab/Experiment               | Testimony                                                                                                                                                      |
|-----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Demo: SQL Injection attack        | [Python Code, Database Interaction, and demo for SQL injection attack](docs_n_demo/1_demo_sql_injection_attack.md)                                             |
| Demo: Man in the middle attack    | [Python Flask API running on insecure HTTP protocol and using tcpdump to see the communication](docs_n_demo/2_demo_insecure_communication_and_read_packets.md) |
| Demo: SSL/TLS Termination         | [Running ingress proxy to handle all SSL communication and securing the backend insecure Python Flask App](docs_n_demo/3_demo_securing_http_communication.md)  |
| Demo: Different listening address | [Difference of listening on 0.0.0.0 vs others](docs_n_demo/4_demo_different_listening_address.md)                                                              |